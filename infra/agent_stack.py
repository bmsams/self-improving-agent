"""CDK Stack for Self-Improving Agent on AWS Bedrock AgentCore.

Provisions:
- ECR Repository for Docker image
- CodeBuild project for ARM64 container builds
- AgentCore Memory (30-day event retention)
- AgentCore Code Interpreter (sandboxed execution)
...
class SelfImprovingAgentStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        memory_name = CfnParameter(
            ...
            "MemoryName",
            type="String",
            default="SelfImprovingAgentMemory",
        ...
        anthropic_secret = secretsmanager.Secret(
            self,
            "AnthropicApiKey",
            secret_name=f"{self.stack_name}/anthropic-api-key",
        ...
        source_asset = s3_assets.Asset(
            self, "SourceAsset", path=os.path.join(os.path.dirname(__file__), "..")
        )
        ...
        build_project = codebuild.Project(
            ...
            description=f"Build self-improving agent Docker image for {self.stack_name}",
            role=codebuild_role,
                    ...
                    "phases": {
                        ...
                        "build": {
                            "commands": [
                                ...
                                "echo Building the Docker image for self-improving agent...",
        ...
        anthropic_secret.grant_read(agent_role)
        ...
        memory = bedrockagentcore.CfnMemory(
            ...
            description=f"Episodic memory for {self.stack_name} self-improving agent",
        ...
        code_interpreter = bedrockagentcore.CfnCodeInterpreterCustom(
            ...
            description=f"Sandboxed code execution for {self.stack_name}",
        )
        ...
        agent_runtime = bedrockagentcore.CfnRuntime(
            ...
            description=f"Self-improving agent runtime for {self.stack_name}",
            environment_variables={
        ...
        agent_runtime.node.add_dependency(code_interpreter)
